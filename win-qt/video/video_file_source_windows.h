 ...
 * video/video_file_source_windows.h — Video file playback source (Media Foundation)
 *
 * Decodes video files using Media Foundation Source Reader.
 * Delivers BGRA frames via the VideoSource callback interface.
 *
 * Windows API: Media Foundation (IMFSourceReader for file decode)
 *
 * Copyright (c) 2026 David St. John <davestj@gmail.com>
 * SPDX-License-Identifier: GPL-2.0-or-later
 */

#ifndef MC1_VIDEO_FILE_SOURCE_WINDOWS_H
#define MC1_VIDEO_FILE_SOURCE_WINDOWS_H
...
#endif // MC1_VIDEO_FILE_SOURCE_WINDOWS_H
