...
// VS2022: __declspec(selectany) makes symbols COMDAT-only, invisible to lib.exe's archive
// symbol table, causing LNK2001 when linking the final DLL. Override FOOGUIDDECL to empty
// here so these definitions are regular external symbols that the linker can resolve.
#ifdef FOOGUIDDECL
#undef FOOGUIDDECL
#endif
#define FOOGUIDDECL
