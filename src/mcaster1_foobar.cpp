...
//static cfg_int mcaster1_show_on_startup("dsp_mcaster1v2",0);//in 0.1 dB
...
void initializeIt()
{
        ...
        //mainWindow->Create((UINT)IDD_MCASTER1, mainApp.GetMainWnd());    
        //mainWindow->Create((UINT)IDD_MCASTER1, CWnd::FromHandle(core_api::get_main_window()));    
...
class dsp_mcaster1 : public dsp_impl_base {
	bool m_chunk_valid;
...
class initquit_mcaster1 : public initquit
{
public:
...
class mcaster1_play_callback_ui : public play_callback_static
{
...
static dsp_factory_nopreset_t<dsp_mcaster1> odd_foo;

//static dsp_factory_t<dsp_mcaster1> odd_foo;

//static service_factory_single_t<dsp_mcaster1> odd_foo;
static service_factory_single_t<initquit_mcaster1> odd_foo_init;
static service_factory_single_t<mcaster1_play_callback_ui> odd_foo_play_callback;