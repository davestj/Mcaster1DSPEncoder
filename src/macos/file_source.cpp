...
// Phase 3 — Mcaster1DSPEncoder macOS Qt 6 Build
//
// Dependencies (Homebrew):
//   brew install mpg123 ffmpeg
//
// Build flags supplied by Makefile.am AM_CPPFLAGS (do NOT include config.h):
//   -DHAVE_MPG123   : enables libmpg123 MP3 decode path
//   -DHAVE_AVFORMAT : enables FFmpeg libavformat/libavcodec/libswresample path
//
// std::filesystem requires macOS 10.15+ (Catalina) or later.
// All real-time pacing uses std::chrono::steady_clock — fully portable.
//
