...
//
// Usage:
//   ArchiveWriter aw("/tmp/mcaster1-archives", "station1");
//   aw.open(44100, 2);
...
public:
    struct Config {
        std::string archive_dir   = "/tmp/mcaster1-archives"; // base output directory
    ...
    ArchiveWriter();                          // default config (/tmp/mcaster1-archives, PCM WAV)
