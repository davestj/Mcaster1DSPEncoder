...
CEditMetadata::CEditMetadata(CWnd* pParent /*=NULL*/)
	: CResizableDialog(CEditMetadata::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CEditMetadata, CResizableDialog)
...
BOOL CEditMetadata::OnInitDialog()
{
	...
	AddAnchor(IDC_MANUAL_META_GROUP,  TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_EXT_META_GROUP,     TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_GRABSTATIC,         TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_METADATA,           TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_APPENDSTRING,       TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_META_URL,           TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_META_FILE,          TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_WINDOWCLASS,        TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_REMOVESTRINGAFTER,  TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_REMOVESTRINGBEFORE, TOP_LEFT,    TOP_RIGHT);
	AddAnchor(IDC_FINDWINDOW,         TOP_RIGHT,   TOP_RIGHT);
