...
CFindWindow::CFindWindow(CWnd* pParent /*=NULL*/)
	: CResizableDialog(CFindWindow::IDD, pParent)
{
...
BEGIN_MESSAGE_MAP(CFindWindow, CResizableDialog)
...
BOOL CFindWindow::OnInitDialog()
{
	...
	// ResizableLib anchor — list fills the whole dialog
	AddAnchor(IDC_FINDWINDOW, TOP_LEFT, BOTTOM_RIGHT);
