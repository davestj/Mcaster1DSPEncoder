...
static const VtComponentVersion VT_VERSIONS[] = {
    ...
    {"voictune_daemon", "Mcaster1 VoicTune Daemon v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "Voice analysis and coaching daemon — HTTP/HTTPS API, auth, DB, WebSocket, USB hotplug, Ollama AI",
     "v2.0.0: Full skeleton — 17 source files, PortAudio, FFT, pitch, meters, coach, WebSocket, USB hotplug, MariaDB, Ollama client."},

    {"vt_fft", "Mcaster1 VoicTune FFT Analyzer v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "Real-time FFT spectrum analysis with kiss_fft — Hann window, magnitude dB, parabolic peak interpolation",
     "v2.0.0: kiss_fft wrapper, Hann window, magnitude spectrum, peak frequency, spectral centroid."},

    {"vt_meters", "Mcaster1 VoicTune Audio Meters v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "Thread-safe RMS, peak, and LUFS (ITU-R BS.1770-4) metering with atomic reads",
     "v2.0.0: RMS dB, peak dB, peak hold, momentary LUFS (400ms window)."},

    {"vt_pitch", "Mcaster1 VoicTune Pitch Detector v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "Musical pitch detection — autocorrelation with FFT peak hint, note name + octave + cents deviation",
     "v2.0.0: Autocorrelation fundamental, A4=440Hz equal temperament, MIDI note mapping."},

    {"vt_worker_pool", "Mcaster1 VoicTune Worker Pool v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "Fixed-size thread pool for parallel FFT/pitch/meter analysis — condition_variable task queue",
     "v2.0.0: Configurable thread count, submit/stop, queue depth monitoring."},

    {"ollama_client", "Mcaster1 Ollama AI Client v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "HTTP client for Ollama LLM API — chat, generate, model listing, availability check",
     "v2.0.0: Chat/generate/list_models/is_available, thread-safe, configurable timeout."},

    {"vt_db", "Mcaster1 VoicTune Database Client v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "MariaDB client for mcaster1_voictune — sessions, voice profiles, analysis snapshots, AI interactions",
     "v2.0.0: Full CRUD for all 4 tables, batch snapshot insert, auto-reconnect."},

    {"vt_audio_capture", "Mcaster1 VoicTune Audio Capture v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "PortAudio device enumeration and mic capture — pushes audio chunks to analysis pipeline",
     "v2.0.0: Device enum, start/stop capture, re-enumerate on hotplug."},

    {"vt_websocket", "Mcaster1 VoicTune WebSocket Server v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "RFC 6455 WebSocket server for browser mic audio — binary PCM frames, JSON control messages",
     "v2.0.0: Handshake, binary/text frames, broadcast, per-client threads, ping/pong."},

    {"vt_usb_monitor", "Mcaster1 VoicTune USB Monitor v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
    ...
    {"vt_coach", "Mcaster1 VoicTune Voice Coach v2.0.1", "2.0.1",
     2, 0, 0, "", "2026-03-27",
     "Rule-based voice coaching — level, peak, sibilance, proximity, pitch drift, pacing analysis",
     "v2.0.0: 6 coaching rules, configurable thresholds, tip rate limiting."},
