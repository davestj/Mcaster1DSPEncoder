...
BOOL CAdvancedSettings::OnInitDialog()
{
	...
	// ResizableLib anchors — groupbox fills page; directory and logfile fields stretch
	AddAnchor(IDC_ADVANCED_GROUP,    TOP_LEFT, BOTTOM_RIGHT);
	AddAnchor(IDC_ARCHIVE_DIRECTORY, TOP_LEFT, TOP_RIGHT);
	AddAnchor(IDC_LOGFILE,           TOP_LEFT, TOP_RIGHT);
